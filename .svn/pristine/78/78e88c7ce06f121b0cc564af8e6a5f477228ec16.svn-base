...
public class kq extends NeckBot<KqSettings, KqState> {
    ...
    @Override
    protected IStateManager<KqState> createStateManager() {
        return new KqStateManager(this, kqListener);
    }
    ...
    protected LoopState<KqState> getState(KqState s) {
        switch (s) {
            ...
            case RESTORING:
                ...
                return new RestoreState<>(this, KqState.RESTORING, HouseConfig.parse(settings),
                        task != null && task.startsWith("Kalphite"));
            case HOPPING:
                return new HoppingState<>(this, settings().worldRegion(), KqState.HOPPING);
            case RESTOCKING:
            ...
            case BREAKING:
                return new BreakHandlerState<>(this.breakManager, this, KqState.BREAKING);
            default:
