...
public class Mole extends NeckBot<MoleSettings, MoleState> {
    ...
    public void attack() {
        ...
        if (m == null) return;
        log.debug("attack");
        di.send(MenuAction.forNpc(m, "Attack"));
    ...
    protected EventListener[] getEventListenerForRunning() {
        return new EventListener[]{prayerFlicker, consumeables, alcher, moleListener, junkDropper};
    }
    ...
    public void onStart(String... arguments) {
        ...
        this.alcher = new AlchListener(this, "Adamant longsword",
                "Mithril platebody",
                "Amulet of strength",
                "Mithril axe",
                "Mithril battleaxe");
    ...
    protected LoopState<MoleState> getState(MoleState s) {
        switch (s) {
            ...
            case RESTORING:
                ...
                return new RestoreState<>(this, MoleState.RESTORING, this.getHouseConfig(),
                        task != null && task.equalsIgnoreCase("giant mole"));
            case HOPPING:
                return new HoppingState<>(this, settings().worldRegion(), MoleState.HOPPING);
            case RESTOCKING:
                return new RestockState(this);
            case BREAKING:
                return new BreakHandlerState<>(this.breakManager, this, MoleState.BREAKING);
            default:
    ...
    public HouseConfig getHouseConfig() {
        return new HouseConfig(settings.hasOrnateJewelleryBox(), settings.hasOrnatePool());
    }
    ...
    @Override
    protected IStateManager<MoleState> createStateManager() {
        return new MoleStateManager(this, moleListener);
    }
