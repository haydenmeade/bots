...
public class Traverses {
    ...
    public static final TraverseMethod[] JORMUNGANDS_PRISON = new TraverseMethod[]{
            ...
            new TeleportTraverse(TeleportSpellInfo.WATERBIRTH),
            new HousePortalTraverse(PortalNexusTeleport.LunarIsle),
            new FairyRingTraverse(FairyRing.DKS)
    };

    public static final TraverseMethod[] ANCIENT_CAVERN = new TraverseMethod[]{
            new ItemTraverse(items.fishingCape, "Otto's Grotto").withPriority(1),
            new GamesNecklaceTraverse(GamesNecklaceTraverse.Destination.BarbarianOutpost),
            new TeleportTraverse(TeleportSpellInfo.BARBARIAN),
            new MinigameTeleportTraverse(MinigameTeleport.BARBARIAN_ASSAULT)
    };
    ...
    public static final TraverseMethod[] BANK = new TraverseMethod[]{
            ...
            new ItemTraverse(items.farmingCape, "Teleport").withPriority(2),
    ...
    public static final int[] JORMUNGANDS_PRISON_REGIONS = new int[]{9890, 9634, 9891, 9635, 10552, 10808, 11064, 10809, 10553, 10297, 9790, 10810, 10554, 10042, 8253, 8509, 8252, 8508};
    public static final int[] ANCIENT_CAVERN_REGIONS = new int[]{10038, 10039, 6995};
    public static final int[] IOWERTH_REGIONS = new int[]{12894, 13150, 13151, 12895, 12994, 12993,};
    public static final TraverseMethod[] IORWERTH_TRAVERSES = new TraverseMethod[]{
            new HouseLocationTraverse(House.Location.PRIFDDINAS),
            new ConstructionCapeTraverse(ConstructionCapeTraverse.Destination.Prifddinas),
            new ItemTraverse("Eternal teleport crystal", "Prifddinas"),
            new ItemTraverse("Prifddinas teleport", "Break"),
            new ItemTraverse(Pattern.compile("Teleport crystal \\(.*\\)"), "Prifddinas"),
            new SpiritTreeTraverse(SpiritTreeTraverse.Destination.Prifddinas)
    };
