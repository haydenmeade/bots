...
public class RestockState extends com.neck_flexed.scripts.common.state.RestockState<SarachnisSettings, SarachnisState> {
    ...
    protected Pattern[] getExcept() {
        return util.concatenate(
                ...
                new Pattern[]{items.imbuedHeart, items.ringOfDueling, items.runePouch, items.constructionCape, items.bookOfDead, items.houseTab, items.xericsTalisman,},
