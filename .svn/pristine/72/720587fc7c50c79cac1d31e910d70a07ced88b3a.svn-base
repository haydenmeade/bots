...
@Log4j2(topic = "Phase1Steps")
public class Phase1Steps implements PhaseSteps {
    ...
    public Phase1Steps() {
        ...
        var step1 = new Coordinate(1377, 10267, 0);
        var step2 = new Coordinate(1374, 10270, 0);
        var step3 = new Coordinate(1374, 10275, 0);
    ...
    public @NotNull PhaseSteps.Step GetNextStep(int idx) {
        switch (idx) {
            case 0:
                return new Step(0, HydraListener::isPoisonAttack, HydraListener::isNotOverVent, step0);
            case 1:
                return new Step(1, HydraListener::playerAttacked, step1);
            case 2:
                return new Step(2, HydraListener::playerAttacked, step2);
            case 3:
                return new Step(3, HydraListener::playerAttacked, step3);
            default:
                return new Step(4, HydraListener::isPoisonAttack,
                        h -> h.isPoisonAttack()
