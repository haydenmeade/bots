...
public class ashes extends NeckBot<AshSettings, AshState> implements SettingsListener, PlayerListener {
    ...
    protected LoopState<AshState> getState(AshState s) {
        switch (s) {
            ...
            case BREAKING:
                return new BreakHandlerState(this.breakManager, this, AshState.BREAKING);
            default:
    ...
    @Override
    protected IStateManager<AshState> createStateManager() {
        return new AshStateManager(this);
    }
